...
public class GateApp {
	...
	private JTextField textNewGate;
	...
	private void initialize() {
		...
		frmGateappo.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\szyna\\Desktop\\Documents\\Java-OLD\\Java(Lab5)\\img\\pwr.png"));
		frmGateappo.setTitle("GateApplication");
		frmGateappo.getContentPane().setFont(new Font("Tahoma", Font.PLAIN, 6));
		frmGateappo.setBounds(100, 100, 600, 455);
		...
		btnLoadSampleListOfGates.setBounds(293, 387, 281, 23);
		...
		btnUpdateGate.setBounds(423, 83, 120, 23);
		...
		btnDisplayTheList.setBounds(293, 353, 281, 23);
		frmGateappo.getContentPane().add(btnDisplayTheList);
		
		textNewGate = new JTextField();
		textNewGate.setBounds(23, 82, 130, 24);
		frmGateappo.getContentPane().add(textNewGate);
		textNewGate.setColumns(10);
		...
		JLabel lblListOfGate = new JLabel("List of gates");
		lblListOfGate.setFont(new Font("Tahoma", Font.BOLD, 10));
		lblListOfGate.setHorizontalAlignment(SwingConstants.CENTER);
		lblListOfGate.setBounds(293, 135, 281, 14);
		frmGateappo.getContentPane().add(lblListOfGate);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(293, 160, 281, 182);
