 ...
 * @author Pawel Szynal
 */
public class Test_Wyszukaj_Osobe extends ColumnFixture {
    ...
    public boolean Wyszukaj_Osobe() throws IllegalFormatCodePointException {
        ...
        long osoba = SetUp.aplikacja.aplikacja.Wyszukaj_Osobe(TestPESEL).Get_PESEL();
        return osoba==PESEL ;
    }
